...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::group(['prefix' => 'curriculum'], function(){
		...
		Route::resource('qualifications.cohorts.terms', 'TermController', ['only' => ['create', 'store', 'show']]);
		Route::resource('qualifications.cohorts.terms.assets', 'TermAssetController', ['only' => ['index']]);
