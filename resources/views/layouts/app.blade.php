            ...
            <div class="d-flex align-items-center">
                ...
                <div data-controller="navbar">
                    <button class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"
                             data-target="navbar.button" data-action="click->navbar#toggle">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse" id="navbarNav" data-target="navbar.menu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown" data-controller="dropdown">
                                ...
                                <div class="dropdown-menu" data-target="dropdown.menu">
                                    ...
                                    <a href="{{ route('reports.tags') }}" class="dropdown-item">Tags vs. vakken</a>
